			...
			<div class="row">
				<ul class="list-group border-top border-bottom list-group-flush w-100">
					...
					<li class="list-group-item">
						...
						<p class="sidebar-color-primary mt-2 mb-0"><?= $os; ?></p>
					</li>
					<li class="list-group-item">
						<span class="vm">Browser</span>
						<p class="sidebar-color-primary mt-2 mb-0"><?= $browser; ?></p>
					</li>
				</ul>
			</div>
		</div>
                ...
                <li class="list-group-item new">
                    <div class="media">
                        <figure class="avatar avatar-40 mr-3">
                            <img data-src="<?= $data['foto'] == true ? $data['foto'] : base_url("assets/files/user_pict/kuser.png") ?>" loading="lazy" class="lazyload" />
                        </figure>
                        <div class="media-body">
                            <h6 class="my-0"><?= $data['nama'] ?></h6>
                            <p><?= $data['jabatan'] ?> <span class="float-right page-sub-title-small"></span></p>
							<?php if(IS_PREMIUM && $this->setting->tampilkan_kehadiran) : ?>
                        ...
                        <div class="card-body">
                            <div class="media">
                                <div class="icon-circle icon-50 bg-light-primary mr-3">
                                    <i class="material-icons"><?= $today > $yesterday ? 'trending_up' : 'trending_down' ?></i>
                                </div>
                                <div class="media-body">
                                    <?php include("$this->theme_folder/$this->theme/commons/statistik_pengunjung.php"); ?>
                                    <?php
                                    ...
                                    ?>
                                    <h4 class="content-color-primary mb-0"><?= ribuan($today) ?> visitors</h4>
                            ...
                            <div class="content-color-secondary text-right">
                                <small>Kemarin <?= ribuan($yesterday) ?> visitors</small>
                            </div>
                        </div>
                    </div>
                </div>
			...
			<a href="<?= site_url('kehadiran'); ?>" rel="noopener noreferrer" target="_blank">
				<ul class="list-group list-group-flush w-100 log-information bubble-sheet mt-2 not-found">
                    <li class="list-group-item">
                        ...
                        <p class="content-color-primary"><i class="material-icons">fingerprint</i> Rekam Kehadiran<br><small class="content-color-secondary">IP Address : <?= $ip; ?></small></p>
					</li>
				</ul>
			</a>
			<?php endif; ?>
