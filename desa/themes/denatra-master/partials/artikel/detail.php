		...
		<div class="card-body">
			<div class="mb-0 content-color-secondary">
				...
				<a data-fancybox="gallery" href="<?= AmbilFotoArtikel($single_artikel['gambar'],'sedang') ?>">
					<img src="<?= AmbilFotoArtikel($single_artikel['gambar'],'sedang') ?>" width="100%" class="cover img-fluid border opacity-100" style="border-radius:5px;" />
				</a>
				<?php endif; ?>
				...
				<a data-fancybox="gallery" href="<?= AmbilFotoArtikel($single_artikel['gambar1'],'sedang')?>">
					<img src="<?= AmbilFotoArtikel($single_artikel['gambar1'],'sedang')?>" class="img-responsive cover img-fluid border opacity-100" style="border-radius:5px;" />
				</a>
				<?php endif; ?>
				...
				<a data-fancybox="gallery" href="<?= AmbilFotoArtikel($single_artikel['gambar2'],'sedang')?>">
					<img src="<?= AmbilFotoArtikel($single_artikel['gambar2'],'sedang')?>" class="img-responsive cover img-fluid border opacity-100 mt-1" style="border-radius:5px;" />
				</a>
				<?php endif; ?>
				...
				<a data-fancybox="gallery" href="<?= AmbilFotoArtikel($single_artikel['gambar3'],'sedang')?>">
					<img src="<?= AmbilFotoArtikel($single_artikel['gambar3'],'sedang')?>" class="img-responsive cover img-fluid border opacity-100 mt-1" style="border-radius:5px;" />
				</a>
				<?php endif; ?>
				...
				<form class="contact_form form-validasi" id="validasi" name="form" action="<?= site_url("add_comment/$single_artikel[id]"); ?>" method="POST" onSubmit="return validasi(this);">
					...
					<div class="row">
						...
						<div class="col-12 col-lg-3 col-md-3 mb-2">
							<div class="input-group">
								<div class="input-group-prepend">
									<input type="text" class="form-control required" autocomplete="off" name="captcha_code" maxlength="6" placeholder="Isikan jawaban" value="<?= $notif['data']['captcha_code']; ?>">
								</div>
							</div>
						</div>
