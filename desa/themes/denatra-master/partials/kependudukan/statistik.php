...
<?php $link = (!in_array($this->uri->segment(1), ['','first'])) || (!in_array($this->uri->segment(3), ['bantuan_penduduk','bantuan_keluarga'])) ?>
<div class="row">
  	<?php if ($link): ?>
	<div class="col-md-4 col-lg-4">
  	...
  	<?php endif; ?>
	<div class="<?= $link ? 'col-md-8 col-lg-8' : 'col-md-12 col-lg-12' ?>">
		<div class="card mb-1">
