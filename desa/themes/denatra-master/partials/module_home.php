...
<div class="card mb-1 has-background-img">
	<section class="py-0 bg-white">
		<div class="card-header pink-gradient font-weight-bold text-center"><i class="fa fa-info-circle"></i> HIMBAUAN<br><small>Tentang : Kebijakan Desa Tanggap Covid-19</small></div>
					...
					<div class="row text-center">
						<div class="col-6 col-lg-2 col-md-2">
							<div class="counter-box text-center mt-2 mb-2">
								<img src="<?= base_url("$this->theme_folder/$this->theme/assets/image/cvd1.png"); ?>" width="100" alt="">
								<div class="small">Gunakan Masker</div>
								<div class="small">Saat Keluar Rumah</div>
							</div>
						</div>
						<div class="col-6 col-lg-2 col-md-2">
							<div class="counter-box text-center mt-2 mb-2">
								<img src="<?= base_url("$this->theme_folder/$this->theme/assets/image/cvd2.png"); ?>" width="100" alt="">
								<div class="small">Cuci Tangan</div>
								<div class="small">Pakai Sabun</div>
							</div>
						</div>
                        <div class="col-6 col-lg-2 col-md-2">
							<div class="counter-box text-center mt-2 mb-2">
								<img src="<?= base_url("$this->theme_folder/$this->theme/assets/image/cvd3.png"); ?>" width="100" alt="">
								<div class="small">Jaga Jarak</div>
								<div class="small">Minimal 1 Meter</div>
                            </div>
                        </div>
                        <div class="col-6 col-lg-2 col-md-2">
                            <div class="counter-box text-center mt-2 mb-2">
								<img src="<?= base_url("$this->theme_folder/$this->theme/assets/image/cvd4.png"); ?>" width="100" alt="">
								<div class="small">Jangan menyentuh</div>
								<div class="small">Wajah</div>
                            </div>
                        </div>
						<div class="col-6 col-lg-2 col-md-2">
                            <div class="counter-box text-center mt-2 mb-2">
								<img src="<?= base_url("$this->theme_folder/$this->theme/assets/image/cvd5.png"); ?>" width="100" alt="">
								<div class="small">Konsumsi</div>
								<div class="small">Makanan Bergizi</div>
                            </div>
                        </div>
                        <div class="col-6 col-lg-2 col-md-2">
                            <div class="counter-box text-center mt-2 mb-2">
								<img src="<?= base_url("$this->theme_folder/$this->theme/assets/image/cvd6.png"); ?>" width="100" alt="">
								<div class="small">Kurangi Mobilitas</div>
								<div class="small">Stay at Home</div>
							</div>
						</div>
					</div>
				</div>
