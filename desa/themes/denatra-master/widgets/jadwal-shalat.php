			...
			<div class="media border-bottom mb-0">
				<div class="media-body">
					<span class="font-weight-bold">
						<a href="https://www.ariandi.net/kode" rel='noopener noreferrer' target='_blank' ><i class="material-icons icon arrow">brightness_4</i> JADWAL di <span data-name="kota">...</span></a>
					</span>
				</div>
			</div>
			<div class="row">
