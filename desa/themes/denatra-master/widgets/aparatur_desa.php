...
<div class="card mb-1 z-index-1">
	...
	<div class="card-body text-center">
		...
		data-cycle-desc="<?= $data['jabatan'] ?><br><?php if(IS_PREMIUM && $this->setting->tampilkan_kehadiran) : ?><span class='badge badge-<?= $data['status_kehadiran'] == 'hadir' ? 'success' : 'danger' ?>'><?= $data['status_kehadiran'] == 'hadir' ? 'Hadir di Kantor Desa' : 'Belum Rekam Kehadiran' ?></span><?php endif; ?>"
		>
		<?php endforeach; ?>
		</div>
	</div>
