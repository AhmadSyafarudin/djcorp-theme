...
?>
<div class="row">
	<div class="container<?= config_item('fluid') ? '-fluid' : '' ?> main-container text-center mt-0 mb-1">
			...
			<div class="col-12 <?= config_item('fluid') ? 'col-lg-4 col-md-4' : 'col-lg-6 col-md-6' ?>">
				<div class="card mb-1">
					<a href="<?= $url ?>" title="Baca Selengkapnya">
						<div class="background-img blog-header-img d-md-none d-lg-none d-xl-none" style="<?= config_item('fluid') ? 'max-height:220px' : 'max-height:300px' ?>">
						...
						<div class="background-img blog-header-img text-hide-xs" style="<?= config_item('fluid') ? 'max-height:220px; min-height:220px' : 'max-height:300px; min-height:300px' ?>">
							<img src="<?= $image ?>" class="<?php $image !== base_url("$this->theme_folder/$this->theme/assets/image/noimage.png") and print('img-responsive cover img-fluid opacity-100') ?>">
						</div>
					</a>
	...
	<?php else: ?>	
	<div class="container<?= config_item('fluid') ? '-fluid' : '' ?> main-container h-100">
