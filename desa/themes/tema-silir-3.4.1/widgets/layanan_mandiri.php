...
<form  action="<?= $action_link ?>" method="post" class="shadow rounded-xl bg-primary dark:bg-dark-secondary overflow-hidden relative">
  ...
  <div class="p-5 -mt-10 space-y-4 pb-8">
    <div class="bg-slate-200 dark:bg-dark-primary py-2 px-4 border-l-4 border-secondary text-secondary">
      <p class="text-xs"><i class="fa fa-info-circle fa-lg mr-2"></i> Hubungi operator desa untuk memperoleh PIN</p>
    </div>
    ...
    <button type="submit" class="button button-tertiary w-full mt-10 hover:ring-offset-primary">Masuk</button>
  </div>
</form>
