...
<div class="flex justify-between items-center space-x-1">
  ...
  <div class="text-right space-x-2 text-sm space-y-2 md:space-y-0">
    <button class="button button-secondary button-switch" data-type="column">Bar Graph</button>
    <button class="button button-secondary button-switch is-active" data-type="pie">Pie Graph</button>
  </div>
</div>
...
<div class="flex justify-between">
  <?php if($hide == 'more') : ?>
    <button class="button button-primary button-more" id="showData">Selengkapnya...</button>
  <?php endif ?>
  <button id="showZero" class="button button-secondary">Tampilkan Nol</button>
</div>
