...
<h1 class="text-heading text-lg lg:text-2xl border-b border-dotted border-primary dark:border-white pb-2 title"><i data-feather="bar-chart" class="inline-block mr-1"></i> Data Vaksinasi</h1>
