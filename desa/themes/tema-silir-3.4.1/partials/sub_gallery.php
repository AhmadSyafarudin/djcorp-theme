...
<h1 class="text-heading text-lg lg:text-2xl border-b border-dotted border-primary dark:border-white pb-2 title">Galeri Album <a href="<?= site_url('first/gallery') ?>" class="text-link with-underline"><?= $parrent['nama'] ?></a></h1>
