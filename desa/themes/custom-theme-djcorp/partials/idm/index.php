...
<div class="content">
  <h1 class="text-heading text-lg lg:text-2xl border-b border-dotted border-primary dark:border-white pb-2 title"><i data-feather="pie-chart" class="inline-block mr-1"></i> Status IDM</h1>
