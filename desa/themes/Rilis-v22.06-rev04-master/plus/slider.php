...
<?php if($slider_gambar['gambar']) : ?>
	<div class="carouselright js-flickity" data-flickity='{ "autoPlay": true, "cellAlign": "left", "fade": "true" }'>
	...
	<?php else: ?>
		...
		<div class="image-slider">
			...
			<div class="image-slider-2" style="background-image:url(<?= base_url('desa/pengaturan/images/latar_website.jpg') ?>);"></div>
			<div class="backg-noslide bggradient1"></div>
			<div class="image-slider-shadow"></div>
		</div>
		</div>
	<?php endif ?>			
